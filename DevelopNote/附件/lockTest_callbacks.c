...
static void addUserCommand(void)
{
	zclSimpleCommand(ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_MANUFACTURER_SPECIFIC_MASK |ZCL_FRAME_CONTROL_CLIENT_TO_SERVER, \
	                   (ZCL_DOOR_LOCK_CLUSTER_ID),                                                       		\
	                   (0x00));
}

static void deleteUserCommand(void)
{
	zclSimpleCommand(ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_MANUFACTURER_SPECIFIC_MASK |ZCL_FRAME_CONTROL_CLIENT_TO_SERVER, \
	                   (ZCL_DOOR_LOCK_CLUSTER_ID),                                                       		\
	                   (0x01));
...
static void adminVerifyCommand(void)
{
	zclSimpleCommand(ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_MANUFACTURER_SPECIFIC_MASK |ZCL_FRAME_CONTROL_CLIENT_TO_SERVER, \
	                   (ZCL_DOOR_LOCK_CLUSTER_ID),                                                       		\
	                   (0x04));
...
static void timeSyncCommand(void)
{
	zclSimpleCommand(ZCL_CLUSTER_SPECIFIC_COMMAND | ZCL_MANUFACTURER_SPECIFIC_MASK |ZCL_FRAME_CONTROL_CLIENT_TO_SERVER, \
	                   (ZCL_DOOR_LOCK_CLUSTER_ID),                                                       		\
	                   (0x10));
...
EmberCommandEntry emberAfCustomCommands[] = {
  ...
  emberCommandEntryAction("add-user", addUserCommand, "vuubb", "add user test"),
  emberCommandEntryAction("delete-user", deleteUserCommand, "vu", "delete test"),
  emberCommandEntryAction("admin-verify", adminVerifyCommand, "vub", "admin verify test"),
  emberCommandEntryAction("time-sync", timeSyncCommand, "b", "time sync test"),
